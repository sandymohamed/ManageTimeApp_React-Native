        ...
        buttons={[
          {
            ...
            labelStyle: { fontSize: 10, fontWeight: 400, color: priority === GoalPriority.LOW ? theme.colors.onPrimary : getPriorityColor(GoalPriority.LOW) }
          },
          {
            ...
            labelStyle: { fontSize: 9, fontWeight: 400, color: priority === GoalPriority.MEDIUM ? theme.colors.onPrimary : getPriorityColor(GoalPriority.MEDIUM) }
          },
          {
            ...
            labelStyle: { fontSize: 10, fontWeight: 400, color: priority === GoalPriority.HIGH ? theme.colors.onPrimary : getPriorityColor(GoalPriority.HIGH) }
          },
          {
            ...
            labelStyle: { fontSize: 10, fontWeight: 400, color: priority === GoalPriority.URGENT ? theme.colors.onPrimary : getPriorityColor(GoalPriority.URGENT) }
          },
        ]}
        ...
        buttons={[
          {
            ...
            label: t('goals.status_options.draft'),
            style: {
            ...
            labelStyle: { fontSize: 10, fontWeight: 400, color: status === GoalStatus.DRAFT ? theme.colors.onPrimary : getStatusColor(GoalStatus.DRAFT) }
          },
          {
            value: GoalStatus.ACTIVE,
            label: t('goals.status_options.active'),
            style: {
            ...
            labelStyle: { fontSize: 10, fontWeight: 400, color: status === GoalStatus.ACTIVE ? theme.colors.onPrimary : getStatusColor(GoalStatus.ACTIVE) }
          },
          {
            value: GoalStatus.PAUSED,
            label: t('goals.status_options.paused'),
            style: {
            ...
            labelStyle: { fontSize: 10, fontWeight: 400, color: status === GoalStatus.PAUSED ? theme.colors.onPrimary : getStatusColor(GoalStatus.PAUSED) }
          },
          {
            value: GoalStatus.DONE,
            label: t('goals.status_options.done'),
            style: {
            ...
            labelStyle: { fontSize: 10, fontWeight: 400, color: status === GoalStatus.DONE ? theme.colors.onPrimary : getStatusColor(GoalStatus.DONE) }
          },
        ]}
        style={styles.segmentedButtons}
      />
